...
const ReviewTaskApplication = ({ toggleModal }: ReviewTaskApplicationProps) => {
    ...
    return (
        <PopupModalLayout title="Review Task Application" toggleModal={toggleModal}>
            ...
            <div className="grid grid-cols-5 gap-2.5 text-light-100 mt-5">
                ...
                <div className="p-[15px] border border-dark-200 space-y-2.5">
                    <p className="text-body-micro">Platform Earnings</p>
                    <p className="text-headline-medium font-normal">$4,786</p>
                </div>
                <div className="p-[15px] border border-dark-200 space-y-2.5">
